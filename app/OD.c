...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1016_consumerHeartbeatTime = {0x00011388, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000},
    .x1017_producerHeartbeatTime = 0x0320,
    .x1018_identity = {
        .highestSub_indexSupported = 0x08,
        .vendor_ID = 0x53534F46,
        .productCode = 0x444E4853,
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_adc = {
        ...
        {
            .dataOrig = &OD_RAM.x6000_adc.t_mcu,
            .subIndex = 10,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 2
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x0B, ODT_REC, &ODObjs.o_6000_adc, NULL},
